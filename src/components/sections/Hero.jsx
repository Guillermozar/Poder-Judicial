    ...
    <section className="relative pt-24 pb-32 lg:pt-32 lg:pb-40 flex items-center overflow-hidden bg-primary-900">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-2xl text-white">
          <span className="bg-primary-600 text-white px-3 py-1 rounded text-sm font-bold mb-4 inline-block tracking-wide uppercase shadow-sm">PORTAL OFICIAL</span>
          <h2 className="text-4xl md:text-5xl font-extrabold mb-6 leading-tight">Justicia Pronta y Transparente al servicio de Itapúa</h2>
          <p className="text-lg md:text-xl text-primary-100 mb-8 font-light leading-relaxed">
            Acceda a todos los servicios judiciales, consultas de expedientes y trámites administrativos de forma digital y segura.
          </p>
          <div className="flex flex-wrap gap-4">
            ...
            >
              <Gavel size={20} /> EXPEDIENTE ELECTRÓNICO
            </a>
