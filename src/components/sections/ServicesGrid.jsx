...
const ServicesGrid = () => {
  ...
  const services = [
    ...
    { title: t('services.criminal_records.title'), icon: <ShieldCheck className="w-8 h-8" />, desc: t('services.criminal_records.desc'), color: "bg-emerald-600", link: "#" },
    ...
    { title: t('services.mediation.title'), icon: <Users className="w-8 h-8" />, desc: t('services.mediation.desc'), color: "bg-indigo-600", link: "#" },
